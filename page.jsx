...
export default function GroupDetailsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6">
      ...
      {/* Tabs */}
      <div className="flex overflow-x-auto bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-200 dark:border-slate-700 mb-6 p-1 gap-1">
        <button
          onClick={() => setActiveTab('posts')}
          className={`flex-1 min-w-[100px] py-2.5 px-4 text-sm font-semibold text-center transition-all duration-200 rounded-xl whitespace-nowrap ${activeTab === 'posts'
        ...
        >
          <i className="fas fa-stream mr-2"></i> Posts
        </button>
        <button
          onClick={() => setActiveTab('discussions')}
          className={`flex-1 min-w-[120px] py-2.5 px-4 text-sm font-semibold text-center transition-all duration-200 rounded-xl whitespace-nowrap ${activeTab === 'discussions'
            ? 'text-white bg-gradient-to-r from-blue-600 to-indigo-600 shadow-md'
            : 'text-gray-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-50 dark:hover:bg-slate-700'
            }`}
        >
        ...
        <button
          ...
          className={`flex-1 min-w-[110px] py-2.5 px-4 text-sm font-semibold text-center transition-all duration-200 rounded-xl whitespace-nowrap ${activeTab === 'members'
            ? 'text-white bg-gradient-to-r from-blue-600 to-indigo-600 shadow-md'
            : 'text-gray-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-50 dark:hover:bg-slate-700'
            }`}
        >
        ...
        {group.userRole === 'ADMIN' && (
          <button
            ...
            className={`flex-1 min-w-[110px] py-2.5 px-4 text-sm font-semibold text-center transition-all duration-200 rounded-xl whitespace-nowrap ${activeTab === 'requests'
              ? 'text-white bg-gradient-to-r from-blue-600 to-indigo-600 shadow-md'
              : 'text-gray-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-50 dark:hover:bg-slate-700'
              }`}
          >
            <i className="fas fa-user-plus mr-2"></i> Requests
        ...
        <button
          ...
          className={`flex-1 min-w-[100px] py-2.5 px-4 text-sm font-semibold text-center transition-all duration-200 rounded-xl whitespace-nowrap ${activeTab === 'events'
            ? 'text-white bg-gradient-to-r from-blue-600 to-indigo-600 shadow-md'
            : 'text-gray-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-50 dark:hover:bg-slate-700'
            }`}
        >
