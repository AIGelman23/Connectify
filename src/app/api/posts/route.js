...
export async function POST(request) {
  try {
    ...
    console.log("DEBUG: Received post payload:", body); // <-- Log payload for troubleshooting
    ...
    // Defensive: Ensure the Post model has imageUrl and videoUrl fields
    const post = await prisma.post.create({
      data: {
        authorId: session.user.id,
        content,
        imageUrl, // now allowed
        videoUrl, // now allowed
      },
      include: {
        author: {
          select: {
