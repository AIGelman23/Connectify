...
export default function ExperienceModal({ isOpen, onClose, onSave, experienceToEdit }) {
	...
	return (
		<div className="fixed inset-0 bg-black/50 dark:bg-black/70 flex items-center justify-center z-50 p-4">
			<div className="p-8 rounded-md shadow w-full max-w-md bg-white dark:bg-slate-800 animate-scale-in">
				<h3 className="text-2xl font-bold mb-6 border-b pb-2 text-gray-900 dark:text-white dark:border-slate-600">
				...
				<div className="space-y-4">
					<div>
						...
						<input
							...
							className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-1 ${errors.title ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 dark:border-slate-600 focus:ring-indigo-500'
					...
					<div>
						...
						<input
							...
							onChange={handleChange}
							className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-1 ${errors.company ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 dark:border-slate-600 focus:ring-indigo-500'
								} dark:bg-slate-700 dark:text-white`}
						/>
				...
				<div className="flex justify-end space-x-3 mt-6">
					<button
						onClick={onClose}
						className="px-5 py-2 bg-gray-200 dark:bg-slate-600 text-gray-700 dark:text-gray-200 font-semibold rounded-md hover:bg-gray-300 dark:hover:bg-slate-500 transition duration-150 ease-in-out"
					>
						Cancel
					</button>
					<button
