...
export default function Lightbox({ images = [], initialIndex = 0, isOpen, onClose, post, sessionUserId, onLikeComment, onReply, onDeleteComment, onAddComment, onReaction }) {
